...
```
git clone https://github.com/zearp/pumice-centos && cd pumice-centos
...
sudo podman run --privileged --rm -it --network=host -v /dev:/dev -v $PWD:/code:z -v /var/cache/kiwi:/var/cache/kiwi:z -w /code quay.io/centos/centos:stream10 /bin/bash
```
...
```
sudo rm -rf /replace/with/path/to/pumice-centos
